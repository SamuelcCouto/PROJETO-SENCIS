      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
          <div className="lg:sticky lg:top-32 lg:self-start">
            ...
            <p className="mt-4 max-w-[46ch] text-clay">
          ...
          <ul className="lista-filete">
            {tratamentos.map((t) => (
              <li key={t.id} className="py-8 first:pt-0">
                ...
                <p className="mt-1.5 text-brass">{t.resolve}</p>
                <p className="mt-3 max-w-[62ch] text-clay">{t.descricao}</p>

                <p className="mt-3 max-w-[62ch] text-[0.8125rem] leading-relaxed text-ink-muted/80">
                ...
                <a
                  ...
                  className="mt-4 inline-block border-b border-sand-deep pb-0.5 text-sm text-clay transition-colors hover:border-brass-mid hover:text-ink"
                >
